...
----
http://gogs-{{INFRA_PROJECT}}.{{ROUTER_ADDRESS}}/userXY/nationalparks/src/{{NATIONALPARKS_VERSION}}
----
...
`http://nexus.{{INFRA_PROJECT}}.svc.cluster.local:8081/content/groups/public`
