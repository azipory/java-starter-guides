...
image::parksmap-image37.png[Explore Project]
...
image::parksmap-image-options-37.png[Explore Project]
...
image::parksmap-image-options-37-labels.png[Explore Project]
...
NOTE: Adding the labels is desired when deploying complex applications for organization purposes.
